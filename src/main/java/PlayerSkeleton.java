...
public class PlayerSkeleton {
	...
	public static void main(String[] args) {
		...
		PlayerSkeleton p = new PlayerSkeleton(new double[] {
			-0.3833217021335531, -0.2991216095851814, -0.9033648455277214, -0.06417739912016285, -0.07057842371336309, -0.09208476184731196, -0.018568446747041722, -0.30384126603893424, -0.3
